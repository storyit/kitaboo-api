...
public class OAuthApplication {
	...
	public static void main(String[] args) {
		...
		if (System.getenv("ACTION").equals("list_books")) {
			...
			// + System.getenv("DATA");
			// String response = callPostService(postServiceUrl,
			// System.getenv("CONSUMER_KEY"),
			// System.getenv("SECRET_KEY"), "", "application/x-www-form-urlencoded");
			// System.out.println(response);
			String consumerKey = System.getenv("CONSUMER_KEY");
			String secretKey = System.getenv("SECRET_KEY");
			String postServiceUrl = "https://cloud.kitaboo.com/DistributionServices/ext/api/order?" + System.getenv("DATA");
			String response = new String();
			HttpURLConnection urlConnection = null;
			try {
				URL url = new URL(postServiceUrl);
